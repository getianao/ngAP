...
def plot(data_paths, figurePath, ylabel):
    ...
    data = figurePlotter.exclude_and_sort_data(
        data, row_dict=apps_selected, column_dict=configs_dict
    )
    ...
    # data = normalize_data(data, "NFA-CG")
    data = normalize_data(data, "ngAP-default")
...
if __name__ == "__main__":
    ...
    path0 = result_folder+"raw/throughput_gpu_sota_best"
