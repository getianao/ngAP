...
def plot(path_list, figurePath, ylabel):
  ...
  colorPalette = ['#ffdc6d', '#a0cc82', '#4c95cb', '#f19b61', '#ae8dca' , '#c1c1c1', '#93bfcf', '#3fcfad']
  colorHatch = ['', '..', 'x', '/', '\\', ':', '--',',']
  figurePlotter.bar(
        apps_labels,
        configs_labels,
...
if __name__ == "__main__":
    ...
    # path4 = result_folder+"/raw/throughput_gpu_nap_default_adp_oneinput"
    path4 = result_folder+"/raw/throughput_gpu_nap_default_adp_e2_oneinput"
    paths = []
    paths.append(path1)
    paths.append(path2)
    paths.append(path3)
    ...
    plot(path_list=paths,
         figurePath=result_folder+"/throughput_gpu_sota_oneinput_o4.pdf",
