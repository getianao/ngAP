...
configs_dict = {
    "symbol_set_type length": ["unique_symbol_set_num", -1],
    "symbol_set_type sum": ["symbol_set_num", -1],
    "redundant_symbol_set_perc": ["reduntant symbol set ratio", 1],
}
...
if __name__ == "__main__":
    ...
    path1 = result_folder + "raw/motivation_e1"
    paths = []
    paths.append(path1)
    # paths.append(path2)
