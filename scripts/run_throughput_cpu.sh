...
CONFIGS="exec_config_ngap_groups_design_cpu" \
./run_throughput.sh  --keywords=../../code/scripts/collect_keyword_list_throughput.txt \
${VALI}  --timeout-mins=60 \
--csvdest=./results/raw/throughput_cpu/throughput_cpu_part1.csv
...
./run_throughput.sh  --keywords=../../code/scripts/collect_keyword_list_throughput.txt \
${VALI}  --timeout-mins=60 \
--csvdest=./results/raw/throughput_cpu/throughput_cpu_part2.csv