...
mkdir -p ../results/raw/throughput_gpu_nap_default_adp_e2

# config: [NAP-default], apps: [part 1, part 2]
APPS="app_spec_ngap_new_quickvalidation_part1" \
CONFIGS="exec_config_ngap_groups_nap_default_e2" \
./run_throughput.sh --keywords=../../code/scripts/collect_keyword_list_throughput.txt \
${VALI}  --timeout-mins=60 --csvdest=./results/raw/throughput_gpu_nap_default_adp_e2/throughput_gpu_nap_default_e2_part1.csv
...
CONFIGS="exec_config_ngap_groups_nap_default_4degree_e2" \
./run_throughput.sh --keywords=../../code/scripts/collect_keyword_list_throughput.txt \
