...
advanceAndFilterNonBlockingAllE2Groups(NonBlockingBuffer nblb,
    ...
    if (node_attr & 0b1000) {
      ...
      if (symbol_set.test(rneighbor_e, rsymbol)) {
        if (false) {
          ...
          int leader = __ffs(mask1) - 1;
          if (threadIdx.x % 32 == leader) {
            addToBufferSimple(rneighbor_e, riter + 1, d_buffer, d_buffer_idx,
                              *d_buffer_start, d_buffer_end_tmp,
                              buffer_capacity_per_block);
            if (node_attrs[rneighbor_e] & 0b10)
              addResult2(rneighbor_e, riter + 1, d_results_v, d_results_i,
                         results_size, nblb.results_capacity, nblb.report_off);
          }
        } else {
          addToBufferSimple(rneighbor_e, riter + 1, d_buffer, d_buffer_idx,
        ...
        if (unique && isUnique) {
          ...
          if (threadIdx.x % 32 == leader) {
            ...
            if (__popc(__activemask()) <= nblb.active_threshold) {
              ...
              processRealVertexR0(rneighbor_e, riter + 1, depth + 1);
            }
          }
        } else {
          if (node_attrs[rneighbor_e] & 0b10)
...
#define __advanceAndFilterNonBlockingAllE2Groups(T1, T2, T3, T4)           \
  template __global__ void                                                     \
  advanceAndFilterNonBlockingAllE2Groups<T1, T2, T3, T4>(                  \
      NonBlockingBuffer nblb, uint8_t * arr_input_streams,                     \
      int arr_input_streams_size, GroupMatchset gms, GroupNodeAttrs gna,       \
      GroupAAS gaas, GroupCsr gcsr);

__advanceAndFilterNonBlockingAllE2Groups(false, 0, false, false);
__advanceAndFilterNonBlockingAllE2Groups(true, 0, false, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 0, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 0, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 0, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 0, true, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 0, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 0, true, true);

__advanceAndFilterNonBlockingAllE2Groups(false, 1, false, false);
__advanceAndFilterNonBlockingAllE2Groups(true, 1, false, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 1, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 1, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 1, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 1, true, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 1, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 1, true, true);

__advanceAndFilterNonBlockingAllE2Groups(false, 2, false, false);
__advanceAndFilterNonBlockingAllE2Groups(true, 2, false, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 2, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 2, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 2, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 2, true, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 2, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 2, true, true);

__advanceAndFilterNonBlockingAllE2Groups(false, 3, false, false);
__advanceAndFilterNonBlockingAllE2Groups(true, 3, false, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 3, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 3, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 3, true, false);
__advanceAndFilterNonBlockingAllE2Groups(false, 3, true, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 3, false, true);
__advanceAndFilterNonBlockingAllE2Groups(true, 3, true, true);
